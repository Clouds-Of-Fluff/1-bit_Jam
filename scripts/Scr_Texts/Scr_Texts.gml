function Scr_Texts(_index){
    var text = [
        ...
        "Option 2 – : Or, announce a workers' safety initiative. Donate a fraction of profits to the families. The public approves… but investors worry about increased costs.",
        ...
        "If you do nothing, your costs go up and your growth slows. But you still have time to react... " + 
        "Now for the final decision. You can either invest $150000 immediately into infrastructure and automation, or allocate $95000 toward policy influence and strategic delay."
